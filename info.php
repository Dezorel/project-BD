        ...
        <div class="card mt-5">
          ...
          <div class="card-body">
            <blockquote class="blockquote mb-0">
              <p>К сожалению такого билета не было найдено :(</p>
              <p>По всей видимости, в данное направление нет билетов на данную дату, либо мы вовсе не летаем туда.</p>
              <p>Попробуйте заказать билет позже, либо свяжитесь с нашими представителями.</p>
                <?php
