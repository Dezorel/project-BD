        ...
        <div class="card mt-5">
          ...
          <div class="card-body">
            <blockquote class="blockquote mb-0">
              ...
              <p>Подробную информацию о вашем заказе вы можете найти на почте, либо воспользоваться check-in на нашей странице</p>
              <p>Номер билета: <?=$idFlight = $_SESSION['order']['id'];?></p>
              <p>Приятного полёта!</p>
                <?php
